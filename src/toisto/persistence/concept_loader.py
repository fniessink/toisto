...
class ConceptLoader:
            ...
            for file_path in file_paths:
                ...
                for label in json.get("labels", []):
                    ...
                    for concept_id in concept_ids:
                        labels.setdefault(concept_id, []).append(label)
    ...
    def _create_concepts(self, concepts: Concepts, labels: dict[ConceptId, Labels]) -> set[Concept]:
        """Create the concepts."""
        return {
