...
class Progress:
    ...
    def next_quiz(self) -> Quiz | None:
        ...
        eligible_quizzes = Quizzes(quiz for quiz in self.__quizzes if self.__is_eligible(quiz))
    ...
    def __has_concept_in_progress(self, quiz: Quiz) -> bool:
        ...
        quizzes_for_same_concept = self.__quizzes.by_concept(quiz.concept)
    ...
    def __root_concepts_have_quizzes(self, quiz: Quiz, quizzes: Quizzes) -> bool:
        ...
        return any(
            ...
            for other_quiz in self.__quizzes.by_concept(root)
