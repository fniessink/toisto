...
CONCEPT_FILE = """
{
    ...
    "labels": [
        {"concept": "concept_id1", "label": "Label1", "language": "fi"},
        {"concept": ["concept_id1", "concept_id2"], "label": "Label2", "language": "nl"}
    ]
}
"""
...
class LoadConceptsTest(ToistoTestCase):
    ...
    def test_load_concepts(self, path_open: Mock) -> None:
        ...
        concept1 = self.create_concept(
            "concept_id1", labels=[dict(label="Label1", language=FI), dict(label="Label2", language=NL)]
        )
        concept2 = self.create_concept("concept_id2", labels=[dict(label="Label2", language=NL)])
