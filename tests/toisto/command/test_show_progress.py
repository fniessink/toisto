...
class ShowProgressTestCase(ToistoTestCase):
    ...
    def setUp(self) -> None:
        ...
        super().setUp()
        concept = self.create_concept("hello", dict(labels=dict(fi="Terve!", nl="Hoi!")))
...
class ShowProgressTest(ShowProgressTestCase):
    ...
    def test_that_generated_spelling_alternatives_are_not_shown(self):
        ...
        concept = self.create_concept("", dict(labels=dict(en="vegetable", nl="de groente")))
...
class ShowProgressSortTestCase(ShowProgressTestCase):
    ...
    def setUp(self) -> None:
        """Set up test fixtures."""
        super().setUp()
        another_concept = self.create_concept("carpet", dict(labels=dict(fi="matto", nl="het tapijt")))
