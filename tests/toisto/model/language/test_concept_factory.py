...
class ConcepFactoryTest(ToistoTestCase):
    ...
    def test_leaf_concept(self):
        ...
        concept = self.create_concept("english", dict(labels=dict(en=["English"], nl=["Engels"])))
    ...
    def test_roots(self):
        ...
        concept = self.create_concept(
            "mall", dict(roots=["shop", "centre"], labels=dict(fi="kauppakeskus", nl="het winkelcentrum"))
        )
        shop = self.create_concept("shop", dict(labels=dict(fi="kauppa")))
    ...
    def test_language_specific_roots(self):
        ...
        decade = self.create_concept("decade", dict(roots=dict(fi="year"), labels=dict(fi="vuosikymmen", en="decade")))
        year = self.create_concept("year", dict(labels=(dict(fi="vuosi"))))
    ...
    def test_roots_are_recursive(self):
        ...
        diner_table_chair = self.create_concept(
            "diner table chair",
            dict(roots=["diner table", "chair"], labels=dict(en="diner table chair", nl="de eettafelstoel")),
        )
        diner_table = self.create_concept(
            "diner table", dict(roots="table", labels=dict(en="diner table", nl="de eettafel"))
        )
        chair = self.create_concept("chair", dict(labels=dict(en="chair", nl="de stoel")))
    ...
    def test_homograph(self):
        ...
        wind_weather = self.create_concept("wind (weather)", dict(labels=dict(en="wind")))
        wind_verb = self.create_concept("wind (verb)", dict(labels=dict(en="wind")))
    ...
    def test_antonym(self):
        ...
        big = self.create_concept("big", dict(antonym="small", labels=dict(en="big")))
        small = self.create_concept("small", dict(labels=dict(en="small")))
    ...
    def test_multiple_antonyms(self):
        ...
        big = self.create_concept("big", dict(antonym=["small", "little"], labels=dict(en="big")))
        little = self.create_concept("little", dict(labels=dict(en="little")))
        small = self.create_concept("small", dict(labels=dict(en="small")))
    ...
    def test_hypernym_and_hyponym(self):
        ...
        canine = self.create_concept("canine", dict(labels=dict(en="canine")))
        dog = self.create_concept("dog", dict(hypernym="canine", labels=dict(en="dog")))
    ...
    def test_hypernyms_and_hyponyms_are_transitive(self):
        ...
        animal = self.create_concept("animal", dict(labels=dict(en="animal")))
        canine = self.create_concept("canine", dict(hypernym="animal", labels=dict(en="canine")))
        dog = self.create_concept("dog", dict(hypernym="canine", labels=dict(en="dog")))
    ...
    def test_holonym_and_meronym(self):
        ...
        animal = self.create_concept("animal", dict(labels=dict(en="animal")))
        tail = self.create_concept("tail", dict(holonym="animal", labels=dict(en="tail")))
    ...
    def test_holonyms_and_meronyms_are_transitive(self):
        ...
        animal = self.create_concept("animal", dict(labels=dict(en="animal")))
        head = self.create_concept("head", dict(holonym="animal", labels=dict(en="head")))
        eye = self.create_concept("eye", dict(holonym="head", labels=dict(en="eye")))
    ...
    def test_answer(self):
        ...
        question = self.create_concept("ice cream", dict(labels=dict(en="Do you like ice cream?"), answer="yes"))
        answer = self.create_concept("yes", dict(labels=dict(en="Yes!")))
    ...
    def test_multiple_answers(self):
        ...
        question = self.create_concept(
            "ice cream", dict(labels=dict(en="Do you like ice cream?"), answer=["yes", "no"])
        )
        yes = self.create_concept("yes", dict(labels=dict(en="Yes!")))
        no = self.create_concept("no", dict(labels=dict(en="No!")))
    ...
    def test_example(self):
        ...
        concept = self.create_concept(
            "next to", dict(example="the museum is next to the church", labels=dict(fi="vieressä"))
        )
        example = self.create_concept(
            "the museum is next to the church", dict(labels=dict(fi="Museo on kirkon vieressä."))
        )
    ...
    def test_multiple_examples(self):
        ...
        concept = self.create_concept("black", dict(example=examples, labels=dict(fi="musta")))
        example1 = self.create_concept("the car is black", dict(labels=dict(fi="Auto on musta.")))
        example2 = self.create_concept("the cars are black", dict(labels=dict(fi="Autot ovat mustia.")))
    ...
    def test_meaning_only_label(self):
        ...
        concept = self.create_concept("Finnish Eastern cake", dict(labels=dict(fi="mämmi", nl="(Finse paascake)")))
    ...
    def test_answer_only(self):
        ...
        concept = self.create_concept("yes", {"answer-only": True, "labels": {"en": "Yes, I do.", "fi": "Pidän."}})
