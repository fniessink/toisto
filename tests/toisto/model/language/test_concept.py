...
class ConceptTest(ToistoTestCase):
    ...
    def test_homographs(self):
        ...
        bank = self.create_concept("bank", labels=[dict(label="de bank;;some note", language=NL)])
    ...
    def test_capitonyms(self):
        ...
        greek = self.create_concept(
            "greek",
            labels=[dict(label="kreikki;;In Finnish, the names of languages are not capitalized", language=FI)],
        )
