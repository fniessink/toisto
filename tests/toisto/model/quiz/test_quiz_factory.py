        ...
        self.assertSetEqual(
            {
                ...
                self.create_quiz(concept, "nl", "en", "Engels", ["English"], "translate"),
        ...
        self.assertSetEqual(
            {
                ...
                self.create_quiz(concept, "nl", "en", "bank", ["couch", "bank"], "translate"),
        ...
        self.assertSetEqual(
            {
                ...
                self.create_quiz(singular, "fi", "nl", "aamu", ["de ochtend"], "translate"),
                ...
                self.create_quiz(plural, "fi", "nl", "aamut", ["de ochtenden"], "translate"),
        ...
        self.assertSetEqual(
            {
                ...
                self.create_quiz(singular, "fi", "nl", "ketsuppi", ["de ketchup"], "translate"),
        ...
        self.assertSetEqual(
            {
                ...
                self.create_quiz(singular, "fi", "nl", "kauppakeskus", ["het winkelcentrum"], "translate"),
                self.create_quiz(singular, "fi", "fi", "ostoskeskus", ["ostoskeskus"], "listen"),
                self.create_quiz(singular, "fi", "nl", "ostoskeskus", ["het winkelcentrum"], "translate"),
                ...
                self.create_quiz(plural, "fi", "nl", "kauppakeskukset", ["de winkelcentra"], "translate"),
                self.create_quiz(plural, "fi", "fi", "ostoskeskukset", ["ostoskeskukset"], "listen"),
                self.create_quiz(plural, "fi", "nl", "ostoskeskukset", ["de winkelcentra"], "translate"),
        ...
        self.assertSetEqual(
            {
                ...
                self.create_quiz(first_person, "fi", "en", "minä syön", ["I eat"], "translate"),
                ...
                self.create_quiz(second_person, "fi", "en", "sinä syöt", ["you eat"], "translate"),
                ...
                self.create_quiz(third_person, "fi", "en", "hän syö", ["she eats", "he eats"], "translate"),
        ...
        self.assertSetEqual(
            {
                ...
                self.create_quiz(female, "fi", "en", "hän on;female", ("she is|she's",), "translate"),
        ...
        self.assertSetEqual(
            {
                ...
                self.create_quiz(first_singular_present, "nl", "fi", "ik ben", ["minä olen"], "translate"),
                ...
                self.create_quiz(second_singular_present, "nl", "fi", "jij bent", ["sinä olet"], "translate"),
                ...
                self.create_quiz(third_singular_present, "nl", "fi", "zij is", ["hän on"], "translate"),
                ...
                self.create_quiz(first_plural_present, "nl", "fi", "wij zijn", ["me olemme"], "translate"),
                ...
                self.create_quiz(second_plural_present, "nl", "fi", "jullie zijn", ["te olette"], "translate"),
                ...
                self.create_quiz(third_plural_present, "nl", "fi", "zij zijn", ["he ovat"], "translate"),
                ...
                self.create_quiz(first_singular_past, "nl", "fi", "ik was", ["minä olin"], "translate"),
                ...
                self.create_quiz(second_singular_past, "nl", "fi", "jij was", ["sinä olit"], "translate"),
                ...
                self.create_quiz(third_singular_past, "nl", "fi", "zij was", ["hän oli"], "translate"),
                ...
                self.create_quiz(first_plural_past, "nl", "fi", "wij waren", ["me olimme"], "translate"),
                ...
                self.create_quiz(second_plural_past, "nl", "fi", "jullie waren", ["te olitte"], "translate"),
                ...
                self.create_quiz(third_plural_past, "nl", "fi", "zij waren", ["he olivät"], "translate"),
        ...
        self.assertSetEqual(
            {
                ...
                self.create_quiz(interrogative, "nl", "en", "Is de auto zwart?", ["Is the cat black?"], "translate"),
        ...
        self.assertSetEqual(
            {
                ...
                self.create_quiz(affirmative, "nl", "en", "De auto is zwart.", ["The cat is black."], "translate"),
        ...
        self.assertSetEqual(
            {
                ...
                self.create_quiz(root, "nl", "nl", "de auto", ["de auto"], "listen"),
                self.create_quiz(root, "nl", "en", "de auto", ["car"], "translate"),
