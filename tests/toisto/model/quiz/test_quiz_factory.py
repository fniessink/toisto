...
class ConceptQuizzesTest(QuizFactoryTestCase):
    ...
    def test_grammatical_number(self):
        ...
        self.assertEqual(
            {
                self.create_quiz(singular, "fi", "nl", "Aamu", ["De ochtend"]),
                self.create_quiz(singular, "nl", "fi", "De ochtend", ["Aamu"]),
                self.create_quiz(singular, "fi", "fi", "Aamu", ["Aamu"], "listen"),
                self.create_quiz(plural, "fi", "nl", "Aamut", ["De ochtenden"]),
                self.create_quiz(plural, "nl", "fi", "De ochtenden", ["Aamut"]),
    ...
    def test_grammatical_number_without_plural(self):
        ...
        self.assertEqual(
            {
                self.create_quiz(singular, "fi", "nl", "Ketsuppi", ["De ketchup"]),
                self.create_quiz(singular, "nl", "fi", "De ketchup", ["Ketsuppi"]),
    ...
    def test_grammatical_number_with_synonyms(self):
        ...
        self.assertEqual(
            {
                self.create_quiz(singular, "fi", "nl", "Kauppakeskus", ["Het winkelcentrum"]),
                self.create_quiz(singular, "fi", "nl", "Ostoskeskus", ["Het winkelcentrum"]),
                self.create_quiz(singular, "nl", "fi", "Het winkelcentrum", ["Kauppakeskus", "Ostoskeskus"]),
                ...
                self.create_quiz(plural, "fi", "nl", "Kauppakeskukset", ["De winkelcentra"]),
                self.create_quiz(plural, "fi", "nl", "Ostoskeskukset", ["De winkelcentra"]),
                self.create_quiz(plural, "nl", "fi", "De winkelcentra", ["Kauppakeskukset", "Ostoskeskukset"]),
    ...
    def test_grammatical_gender(self):
        ...
        self.assertEqual(
            {
                self.create_quiz(female, "nl", "en", "Haar kat", ["Her cat"], "translate"),
                self.create_quiz(female, "en", "nl", "Her cat", ["Haar kat"], "translate"),
                self.create_quiz(female, "nl", "nl", "Haar kat", ["Haar kat"], "listen"),
                self.create_quiz(male, "nl", "en", "Zijn kat", ["His cat"], "translate"),
                self.create_quiz(male, "en", "nl", "His cat", ["Zijn kat"], "translate"),
    ...
    def test_grammatical_gender_with_neuter(self):
        ...
        self.assertEqual(
            {
                self.create_quiz(female, "nl", "en", "Haar bot", ["Her bone"], "translate"),
                self.create_quiz(female, "en", "nl", "Her bone", ["Haar bot"], "translate"),
                self.create_quiz(female, "nl", "nl", "Haar bot", ["Haar bot"], "listen"),
                self.create_quiz(male, "nl", "en", "Zijn bot", ["His bone"], "translate"),
                self.create_quiz(male, "en", "nl", "His bone", ["Zijn bot"], "translate"),
                self.create_quiz(male, "nl", "nl", "Zijn bot", ["Zijn bot"], "listen"),
                self.create_quiz(neuter, "nl", "en", "Zijn bot", ["Its bone"], "translate"),
                self.create_quiz(neuter, "en", "nl", "Its bone", ["Zijn bot"], "translate"),
    ...
    def test_grammatical_number_with_grammatical_gender(self):
        ...
        self.assertEqual(
            {
                self.create_quiz(singular_female, "nl", "en", "Haar kat", ["Her cat"], "translate"),
                self.create_quiz(singular_female, "en", "nl", "Her cat", ["Haar kat"], "translate"),
                self.create_quiz(singular_female, "nl", "nl", "Haar kat", ["Haar kat"], "listen"),
                self.create_quiz(singular_male, "nl", "en", "Zijn kat", ["His cat"], "translate"),
                self.create_quiz(singular_male, "en", "nl", "His cat", ["Zijn kat"], "translate"),
                ...
                self.create_quiz(plural_female, "nl", "en", "Haar katten", ["Her cats"], "translate"),
                self.create_quiz(plural_female, "en", "nl", "Her cats", ["Haar katten"], "translate"),
                self.create_quiz(plural_female, "nl", "nl", "Haar katten", ["Haar katten"], "listen"),
                self.create_quiz(plural_male, "nl", "en", "Zijn katten", ["His cats"], "translate"),
                self.create_quiz(plural_male, "en", "nl", "His cats", ["Zijn katten"], "translate"),
    ...
    def test_degrees_of_comparison(self):
        ...
        self.assertEqual(
            {
                self.create_quiz(positive_degree, "nl", "en", "Groot", ["Big"], "translate"),
                self.create_quiz(positive_degree, "en", "nl", "Big", ["Groot"], "translate"),
                self.create_quiz(positive_degree, "nl", "nl", "Groot", ["Groot"], "listen"),
                self.create_quiz(comparative_degree, "nl", "en", "Groter", ["Bigger"], "translate"),
                self.create_quiz(comparative_degree, "en", "nl", "Bigger", ["Groter"], "translate"),
                self.create_quiz(comparative_degree, "nl", "nl", "Groter", ["Groter"], "listen"),
                self.create_quiz(superlative_degree, "nl", "en", "Grootst", ["Biggest"], "translate"),
                self.create_quiz(superlative_degree, "en", "nl", "Biggest", ["Grootst"], "translate"),
    ...
    def test_degrees_of_comparison_with_synonyms(self):
        ...
        self.assertEqual(
            {
                self.create_quiz(positive_degree, "fi", "en", "Iso", ["Big"], "translate"),
                self.create_quiz(positive_degree, "fi", "en", "Suuri", ["Big"], "translate"),
                self.create_quiz(positive_degree, "en", "fi", "Big", ["Iso", "Suuri"], "translate"),
                self.create_quiz(positive_degree, "fi", "fi", "Iso", ["Iso"], "listen"),
                self.create_quiz(positive_degree, "fi", "fi", "Suuri", ["Suuri"], "listen"),
                self.create_quiz(comparative_degree, "fi", "en", "Isompi", ["Bigger"], "translate"),
                self.create_quiz(comparative_degree, "fi", "en", "Suurempi", ["Bigger"], "translate"),
                self.create_quiz(comparative_degree, "en", "fi", "Bigger", ["Isompi", "Suurempi"], "translate"),
                ...
                self.create_quiz(superlative_degree, "fi", "en", "Isoin", ["Biggest"], "translate"),
                self.create_quiz(superlative_degree, "fi", "en", "Suurin", ["Biggest"], "translate"),
                self.create_quiz(superlative_degree, "en", "fi", "Biggest", ["Isoin", "Suurin"], "translate"),
    ...
    def test_grammatical_person(self):
        ...
        self.assertEqual(
            {
                self.create_quiz(first_person, "nl", "en", "Ik eet", ["I eat"], "translate"),
                self.create_quiz(first_person, "en", "nl", "I eat", ["Ik eet"], "translate"),
                self.create_quiz(first_person, "nl", "nl", "Ik eet", ["Ik eet"], "listen"),
                self.create_quiz(second_person, "nl", "en", "Jij eet", ["You eat"], "translate"),
                self.create_quiz(second_person, "en", "nl", "You eat", ["Jij eet"], "translate"),
                self.create_quiz(second_person, "nl", "nl", "Jij eet", ["Jij eet"], "listen"),
                self.create_quiz(third_person, "nl", "en", "Zij eet", ["She eats"], "translate"),
                self.create_quiz(third_person, "en", "nl", "She eats", ["Zij eet"], "translate"),
        ...
        self.assertEqual(
            {
                ...
                self.create_quiz(second_person, "en", "nl", "You eat", ["Jij eet"], "translate"),
                self.create_quiz(second_person, "nl", "nl", "Jij eet", ["Jij eet"], "listen"),
                self.create_quiz(third_person_female, "nl", "en", "Zij eet", ["She eats"], "translate"),
                self.create_quiz(third_person_female, "en", "nl", "She eats", ["Zij eet"], "translate"),
                self.create_quiz(third_person_female, "nl", "nl", "Zij eet", ["Zij eet"], "listen"),
                self.create_quiz(third_person_male, "nl", "en", "Hij eet", ["He eats"], "translate"),
                self.create_quiz(third_person_male, "en", "nl", "He eats", ["Hij eet"], "translate"),
    ...
    def test_grammatical_number_nested_with_grammatical_person(self):
        ...
        self.assertEqual(
            {
                self.create_quiz(first_person_singular, "nl", "fi", "Ik heb", ["Minulla on"], "translate"),
                self.create_quiz(first_person_singular, "fi", "nl", "Minulla on", ["Ik heb"], "translate"),
                self.create_quiz(first_person_singular, "nl", "nl", "Ik heb", ["Ik heb"], "listen"),
                self.create_quiz(second_person_singular, "nl", "fi", "Jij hebt", ["Sinulla on"], "translate"),
                self.create_quiz(second_person_singular, "fi", "nl", "Sinulla on", ["Jij hebt"], "translate"),
                self.create_quiz(second_person_singular, "nl", "nl", "Jij hebt", ["Jij hebt"], "listen"),
                self.create_quiz(third_person_singular, "nl", "fi", "Zij heeft", ["Hänellä on"], "translate"),
                self.create_quiz(third_person_singular, "fi", "nl", "Hänellä on", ["Zij heeft"], "translate"),
                ...
                self.create_quiz(first_person_plural, "nl", "fi", "Wij hebben", ["Meillä on"], "translate"),
                self.create_quiz(first_person_plural, "fi", "nl", "Meillä on", ["Wij hebben"], "translate"),
                self.create_quiz(first_person_plural, "nl", "nl", "Wij hebben", ["Wij hebben"], "listen"),
                self.create_quiz(second_person_plural, "nl", "fi", "Jullie hebben", ["Teillä on"], "translate"),
                self.create_quiz(second_person_plural, "fi", "nl", "Teillä on", ["Jullie hebben"], "translate"),
                self.create_quiz(second_person_plural, "nl", "nl", "Jullie hebben", ["Jullie hebben"], "listen"),
                self.create_quiz(third_person_plural, "nl", "fi", "Zij hebben", ["Heillä on"], "translate"),
                self.create_quiz(third_person_plural, "fi", "nl", "Heillä on", ["Zij hebben"], "translate"),
    ...
    def test_grammatical_gender_nested_with_grammatical_number(self):
        ...
        self.assertEqual(
            {
                self.create_quiz(female_singular, "nl", "en", "Haar kat", ["Her cat"], "translate"),
                self.create_quiz(female_singular, "en", "nl", "Her cat", ["Haar kat"], "translate"),
                self.create_quiz(female_singular, "nl", "nl", "Haar kat", ["Haar kat"], "listen"),
                self.create_quiz(female_plural, "nl", "en", "Haar katten", ["Her cats"], "translate"),
                self.create_quiz(female_plural, "en", "nl", "Her cats", ["Haar katten"], "translate"),
                ...
                self.create_quiz(male_singular, "nl", "en", "Zijn kat", ["His cat"], "translate"),
                self.create_quiz(male_singular, "en", "nl", "His cat", ["Zijn kat"], "translate"),
                self.create_quiz(male_singular, "nl", "nl", "Zijn kat", ["Zijn kat"], "listen"),
                self.create_quiz(male_plural, "nl", "en", "Zijn katten", ["His cats"], "translate"),
                self.create_quiz(male_plural, "en", "nl", "His cats", ["Zijn katten"], "translate"),
    ...
    def test_same_label_in_different_composite_concepts(self):
        ...
        self.assertEqual(
            {
                self.create_quiz(female, "fi", "en", Label("Hän on;female"), ("She is|She's",)),
                self.create_quiz(female, "en", "fi", "She is|She's", ("Hän on;female",)),
                self.create_quiz(female, "fi", "fi", "Hän on;female", ("Hän on;female",), "listen"),
                self.create_quiz(male, "fi", "en", "Hän on;male", ("He is|He's",)),
                self.create_quiz(male, "en", "fi", "He is|He's", ("Hän on;male",)),
            },
            self.create_quizzes(concept, "fi", "en"),
        )
    ...
    def test_infinitive_verb_form(self):
        ...
        self.assertEqual(
            {
                self.create_quiz(infinitive, "nl", "en", "Slapen", ["To sleep"], "translate"),
                self.create_quiz(infinitive, "en", "nl", "To sleep", ["Slapen"], "translate"),
                self.create_quiz(infinitive, "nl", "nl", "Slapen", ["Slapen"], "listen"),
                self.create_quiz(singular, "nl", "en", "Ik slaap", ["I sleep"], "translate"),
                self.create_quiz(singular, "en", "nl", "I sleep", ["Ik slaap"], "translate"),
                self.create_quiz(singular, "nl", "nl", "Ik slaap", ["Ik slaap"], "listen"),
                self.create_quiz(plural, "nl", "en", "Wij slapen", ["We sleep"], "translate"),
                self.create_quiz(plural, "en", "nl", "We sleep", ["Wij slapen"], "translate"),
    ...
    def test_grammatical_number_nested_with_grammatical_person_and_infinitive(self):
        ...
        self.assertEqual(
            {
                self.create_quiz(first_person_singular, "nl", "fi", "Ik ben", ["Minä olen"], "translate"),
                self.create_quiz(first_person_singular, "fi", "nl", "Minä olen", ["Ik ben"], "translate"),
                ...
                self.create_quiz(second_person_singular, "nl", "fi", "Jij bent", ["Sinä olet"], "translate"),
                self.create_quiz(second_person_singular, "fi", "nl", "Sinä olet", ["Jij bent"], "translate"),
                ...
                self.create_quiz(third_person_singular, "nl", "fi", "Zij is", ["Hän on"], "translate"),
                self.create_quiz(third_person_singular, "fi", "nl", "Hän on", ["Zij is"], "translate"),
                ...
                self.create_quiz(first_person_plural, "nl", "fi", "Wij zijn", ["Me olemme"], "translate"),
                self.create_quiz(first_person_plural, "fi", "nl", "Me olemme", ["Wij zijn"], "translate"),
                ...
                self.create_quiz(second_person_plural, "nl", "fi", "Jullie zijn", ["Te olette"], "translate"),
                self.create_quiz(second_person_plural, "fi", "nl", "Te olette", ["Jullie zijn"], "translate"),
                ...
                self.create_quiz(third_person_plural, "nl", "fi", "Zij zijn", ["He ovat"], "translate"),
                self.create_quiz(third_person_plural, "fi", "nl", "He ovat", ["Zij zijn"], "translate"),
                ...
                self.create_quiz(infinitive, "fi", "nl", "Olla", ["Zijn"], "translate"),
                self.create_quiz(infinitive, "nl", "fi", "Zijn", ["Olla"], "translate"),
...
class TenseQuizzesTest(QuizFactoryTestCase):
    ...
    def test_tense_nested_with_grammatical_person(self):
        ...
        self.assertEqual(
            {
                self.create_quiz(present_singular, "nl", "en", "Ik eet", ["I eat"], "translate"),
                self.create_quiz(present_singular, "en", "nl", "I eat", ["Ik eet"], "translate"),
                self.create_quiz(present_singular, "nl", "nl", "Ik eet", ["Ik eet"], "listen"),
                self.create_quiz(present_plural, "nl", "en", "Wij eten", ["We eat"], "translate"),
                self.create_quiz(present_plural, "en", "nl", "We eat", ["Wij eten"], "translate"),
                ...
                self.create_quiz(past_singular, "nl", "en", "Ik at", ["I ate"], "translate"),
                self.create_quiz(past_singular, "en", "nl", "I ate", ["Ik at"], "translate"),
                self.create_quiz(past_singular, "nl", "nl", "Ik at", ["Ik at"], "listen"),
                self.create_quiz(past_plural, "nl", "en", "Wij aten", ["We ate"], "translate"),
                self.create_quiz(past_plural, "en", "nl", "We ate", ["Wij aten"], "translate"),
        ...
        self.assertEqual(
            {
                ...
                self.create_quiz(concept, "nl", "nl", "Ik at", ["Ik eet"], "give present tense"),
                self.create_quiz(concept, "nl", "nl", "Wij aten", ["Wij eten"], "give present tense"),
                self.create_quiz(infinitive, "nl", "en", "Eten", ["To eat"], "translate"),
                self.create_quiz(infinitive, "en", "nl", "To eat", ["Eten"], "translate"),
...
class SentenceFormTest(ToistoTestCase):
    ...
    def test_declarative_and_interrogative_sentence_types(self):
        ...
        self.assertEqual(
            {
                self.create_quiz(declarative, "nl", "en", "De auto is zwart", ["The car is black"], "translate"),
                self.create_quiz(declarative, "en", "nl", "The car is black", ["De auto is zwart"], "translate"),
                self.create_quiz(declarative, "nl", "nl", "De auto is zwart", ["De auto is zwart"], "listen"),
                self.create_quiz(interrogative, "nl", "en", "Is de auto zwart?", ["Is the car black?"], "translate"),
                self.create_quiz(interrogative, "en", "nl", "Is the car black?", ["Is de auto zwart?"], "translate"),
...
class GrammaticalPolarityTest(ToistoTestCase):
    ...
    def test_affirmative_and_negative_polarities(self):
        ...
        self.assertEqual(
            {
                self.create_quiz(affirmative, "nl", "en", "De auto is zwart", ["The car is black"], "translate"),
                self.create_quiz(affirmative, "en", "nl", "The car is black", ["De auto is zwart"], "translate"),
                self.create_quiz(affirmative, "nl", "nl", "De auto is zwart", ["De auto is zwart"], "listen"),
                self.create_quiz(negative, "nl", "en", "De auto is niet zwart", ["The car is not black"], "translate"),
                self.create_quiz(negative, "en", "nl", "The car is not black", ["De auto is niet zwart"], "translate"),
