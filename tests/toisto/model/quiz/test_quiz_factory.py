        ...
        self.assertEqual(
            set(
                [
                    ...
                    self.create_quiz(
                        "to eat", "nl", "nl", "Jij eet", ["Hij eet"], ("give third person", "masculinize")
                    ),
                    self.create_quiz("to eat", "nl", "nl", "Zij eet", ["Ik eet"], "give first person"),
                    self.create_quiz("to eat", "nl", "nl", "Zij eet", ["Jij eet"], "give second person"),
        ...
        self.assertEqual(
            set(
                [
                    ...
                    self.create_quiz(
                        "to have", "nl", "nl", "Zijn", ["Jij bent"], ("singularize", "give second person")
                    ),
                    ...
                    self.create_quiz(
                        "to have", "nl", "nl", "Zijn", ["Jullie zijn"], ("pluralize", "give second person")
                    ),
