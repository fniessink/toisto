    ...
    def test_grammatical_number_with_synonyms(self):
        ...
        self.assertEqual(
            [
                ...
                self.create_quiz("fi", "fi", "Kauppakeskus", ["Kauppakeskus"], "listen"),
                self.create_quiz("fi", "fi", "Ostoskeskus", ["Ostoskeskus"], "listen"),
                ...
                self.create_quiz("fi", "fi", "Kauppakeskukset", ['Kauppakeskukset'], "listen"),
                self.create_quiz("fi", "fi", "Ostoskeskukset", ['Ostoskeskukset'], "listen"),
    ...
    def test_grammatical_gender_with_neuter(self):
        ...
        self.assertEqual(
            [
                ...
                self.create_quiz("nl", "nl", "Zijn bot", ["Zijn bot"], "listen"),
    ...
    def test_grammatical_number_with_grammatical_gender(self):
        ...
        self.assertEqual(
            [
                ...
                self.create_quiz("nl", "nl", "Haar katten", ["Haar katten"], "listen"),
                self.create_quiz("nl", "en", "Zijn katten", ["His cats"], "translate"),
                self.create_quiz("en", "nl", "His cats", ["Zijn katten"], "translate"),
                self.create_quiz("nl", "nl", "Zijn katten", ["Zijn katten"], "listen"),
    ...
    def test_degrees_of_comparison_with_synonyms(self):
        ...
        self.assertEqual(
            [
                ...
                self.create_quiz("fi", "fi", "Iso", ["Iso"], "listen"),
                self.create_quiz("fi", "fi", "Suuri", ["Suuri"], "listen"),
                ...
                self.create_quiz("fi", "fi", "Isompi", ["Isompi"], "listen"),
                self.create_quiz("fi", "fi", "Suurempi", ["Suurempi"], "listen"),
                ...
                self.create_quiz("fi", "fi", "Isoin", ["Isoin"], "listen"),
                self.create_quiz("fi", "fi", "Suurin", ["Suurin"], "listen"),
    ...
    def test_grammatical_person_nested_with_grammatical_gender(self):
        ...
        self.assertEqual(
            [
                ...
                self.create_quiz("nl", "nl", "Hij eet", ["Hij eet"], "listen"),
