...
QUIZ_TYPE_OPTION = """-q, --quiz-type {quiz type}
                        ...
                        interpret, interrogative, masculine, negative, neuter, nominative, order, ordinal, partitive,
                        past tense, perfective, plural, plural pronoun, positive degree, present tense, read, second
                        person, singular, singular pronoun, superlative degree, third person, verbal noun, write"""
