...
3. Quizzes to feminize a masculine concept or masculinize a feminine concept. Users are only asked to feminize and masculinize concepts in their practice language, not their own language.
4. Quizzes to provide the positive, comparitive, or superlative degree of comparison, given an adjective in another degree.
